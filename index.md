...
venue: "September 2019 SWC workshop @TU/Eindhoven" # brief name of host site without address (e.g., "Euphoric State University")
address: "Eindhoven University of Technology, building Gemini South, room 4.24, Groene Loper (building 15), 5612 AE Eindhoven" # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
instructor: ["Renato Alves", "Nicolas Dintzner"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Esther Plomp, Barbara Vreede, Santosh Ilamparuthi, Peder Isager, Heather Andrews, Dragan Bosnacki, Aliaksei Vasilevich","Koen Graat", "Jan Dvorak"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes:  http://pad.carpentries.org/2019-09-25-Eindhoven #Etherpad will be available. Link soon!   # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
eventbrite:   63069694153 # tue-software-carpentry-workshop-tickets-63069694153  # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
